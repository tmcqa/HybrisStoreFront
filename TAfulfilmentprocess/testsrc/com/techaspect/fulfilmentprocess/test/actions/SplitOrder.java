 ...
 */
package com.techaspect.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TAFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TAFulfilmentProcessConstants.PARENT_PROCESS);
