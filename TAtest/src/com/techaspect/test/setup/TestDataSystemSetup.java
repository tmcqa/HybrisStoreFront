 ...
 */
package com.techaspect.test.setup;
...
import com.techaspect.test.constants.TATestConstants;
import com.techaspect.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TATestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/TAtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/TAtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/TAtest/import/cstickets.impex");
			...
			importImpexFile(context, "/TAtest/import/csquotes.impex");
		}
	}
}
