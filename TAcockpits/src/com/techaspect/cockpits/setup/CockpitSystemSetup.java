 ...
 */
package com.techaspect.cockpits.setup;
...
import com.techaspect.cockpits.constants.TACockpitsConstants;
 ...
 */
@SystemSetup(extension = TACockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TACockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TACockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TACockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/TAcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
