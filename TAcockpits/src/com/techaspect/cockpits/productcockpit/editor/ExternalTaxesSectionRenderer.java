 ...
 */
package com.techaspect.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("TAcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("TAcockpits.product.externalTaxes"));
