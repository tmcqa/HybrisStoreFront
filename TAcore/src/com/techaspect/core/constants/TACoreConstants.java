 ...
 */
package com.techaspect.core.constants;

/**
 * Global class for all TACore constants. You can add global constants for your extension into this class.
 */
public final class TACoreConstants extends GeneratedTACoreConstants
{
	public static final String EXTENSIONNAME = "TAcore";


	private TACoreConstants()
	{
		//empty
	}
