...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/TAstorefront/electronics/en",
						"https://electronics.local:9002/TAstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/TAstorefront/electronics/en",
						"https://electronics.local:9002/TAstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/TAstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/TAstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/TAstorefront/electronics/en",
						"https://electronics.local:9002/TAstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/TAstorefront",
						"https://electronics.local:9002/TAstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/TAstorefront",
						"https://electronics.local:9002/TAstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/TAstorefront/electronics/en",
						"https://electronics.local:9002/TAstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
