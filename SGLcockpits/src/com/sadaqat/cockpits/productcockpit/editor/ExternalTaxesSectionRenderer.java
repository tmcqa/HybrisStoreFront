 ...
 */
package com.sadaqat.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("SGLcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("SGLcockpits.product.externalTaxes"));
