 ...
 */
package com.sadaqat.cockpits.setup;
...
import com.sadaqat.cockpits.constants.SGLCockpitsConstants;
 ...
 */
@SystemSetup(extension = SGLCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SGLCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SGLCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SGLCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/SGLcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
