 ...
 */
package com.sadaqat.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SGLFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SGLFulfilmentProcessConstants.PARENT_PROCESS);
