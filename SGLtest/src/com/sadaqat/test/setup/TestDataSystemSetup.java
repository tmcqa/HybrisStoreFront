 ...
 */
package com.sadaqat.test.setup;
...
import com.sadaqat.test.constants.SGLTestConstants;
import com.sadaqat.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SGLTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/SGLtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/SGLtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/SGLtest/import/cstickets.impex");
			...
			importImpexFile(context, "/SGLtest/import/csquotes.impex");
		}
	}
}
